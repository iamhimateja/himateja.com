import { myAlternativeEmailId, myMailId, socialLinks } from '@globals/constants'
import { CodepenIcon, GithubIcon, LinkedInIcon } from '@v3/components/svg'
    ...
    <div className={styles.container}>
      <div className={styles.footer}>
        <div className={styles.avatarBar}>
          <Link href="/v3" className={styles.link} aria-label="Go to Home" tabIndex={0}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.footerLinks}>
            ...
            <div className={styles.copyright}>
              ...
              <Link href="/v3" className={styles.link} aria-label="This website's copyright" tabIndex={0}>
