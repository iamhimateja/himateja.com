            ...
            <ol className="mt-8 space-y-6">
              <li className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2 text-xs font-medium">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-primary-50 text-black">50</div>
              ...
              <li className="space-y-2">
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>
                  Useful for indicating navigation, I use this quite a lot, so why not build a component with some
                  whimsy touch?
                </p>
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <ArrowLink as={ButtonLink} variant="light" className="inline-flex items-center" href="/">
                    Polymorphic
                  </ArrowLink>
                </div>
              </li>
              <li className="space-y-2">
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>Button styled link with 3 variants.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <li className="space-y-2">
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>Styled 404 page with some animation.</p>
                <div className="flex flex-wrap gap-2">
              ...
              <li className="space-y-2">
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>Next Image with default props and skeleton animation</p>
                <NextImage
                  useSkeleton
